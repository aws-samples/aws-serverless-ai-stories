          ...
          <div className="mx-auto max-w-4xl flex items-center align-middle h-screen -mt-20">
            <div className="text-center pt-20 items-center">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-pink-500">Experience the Magic of AI-Generated Stories for Your Kids</span>
              </h1>
              <h2 className="text-xl font-bold tracking-tight text-gray-300 sm:text-xl py-6 max-w-xl mx-auto">
                Open source event-driven application that generates a new bed time story for your children every night.
              </h2>
              <button
                type="button"
